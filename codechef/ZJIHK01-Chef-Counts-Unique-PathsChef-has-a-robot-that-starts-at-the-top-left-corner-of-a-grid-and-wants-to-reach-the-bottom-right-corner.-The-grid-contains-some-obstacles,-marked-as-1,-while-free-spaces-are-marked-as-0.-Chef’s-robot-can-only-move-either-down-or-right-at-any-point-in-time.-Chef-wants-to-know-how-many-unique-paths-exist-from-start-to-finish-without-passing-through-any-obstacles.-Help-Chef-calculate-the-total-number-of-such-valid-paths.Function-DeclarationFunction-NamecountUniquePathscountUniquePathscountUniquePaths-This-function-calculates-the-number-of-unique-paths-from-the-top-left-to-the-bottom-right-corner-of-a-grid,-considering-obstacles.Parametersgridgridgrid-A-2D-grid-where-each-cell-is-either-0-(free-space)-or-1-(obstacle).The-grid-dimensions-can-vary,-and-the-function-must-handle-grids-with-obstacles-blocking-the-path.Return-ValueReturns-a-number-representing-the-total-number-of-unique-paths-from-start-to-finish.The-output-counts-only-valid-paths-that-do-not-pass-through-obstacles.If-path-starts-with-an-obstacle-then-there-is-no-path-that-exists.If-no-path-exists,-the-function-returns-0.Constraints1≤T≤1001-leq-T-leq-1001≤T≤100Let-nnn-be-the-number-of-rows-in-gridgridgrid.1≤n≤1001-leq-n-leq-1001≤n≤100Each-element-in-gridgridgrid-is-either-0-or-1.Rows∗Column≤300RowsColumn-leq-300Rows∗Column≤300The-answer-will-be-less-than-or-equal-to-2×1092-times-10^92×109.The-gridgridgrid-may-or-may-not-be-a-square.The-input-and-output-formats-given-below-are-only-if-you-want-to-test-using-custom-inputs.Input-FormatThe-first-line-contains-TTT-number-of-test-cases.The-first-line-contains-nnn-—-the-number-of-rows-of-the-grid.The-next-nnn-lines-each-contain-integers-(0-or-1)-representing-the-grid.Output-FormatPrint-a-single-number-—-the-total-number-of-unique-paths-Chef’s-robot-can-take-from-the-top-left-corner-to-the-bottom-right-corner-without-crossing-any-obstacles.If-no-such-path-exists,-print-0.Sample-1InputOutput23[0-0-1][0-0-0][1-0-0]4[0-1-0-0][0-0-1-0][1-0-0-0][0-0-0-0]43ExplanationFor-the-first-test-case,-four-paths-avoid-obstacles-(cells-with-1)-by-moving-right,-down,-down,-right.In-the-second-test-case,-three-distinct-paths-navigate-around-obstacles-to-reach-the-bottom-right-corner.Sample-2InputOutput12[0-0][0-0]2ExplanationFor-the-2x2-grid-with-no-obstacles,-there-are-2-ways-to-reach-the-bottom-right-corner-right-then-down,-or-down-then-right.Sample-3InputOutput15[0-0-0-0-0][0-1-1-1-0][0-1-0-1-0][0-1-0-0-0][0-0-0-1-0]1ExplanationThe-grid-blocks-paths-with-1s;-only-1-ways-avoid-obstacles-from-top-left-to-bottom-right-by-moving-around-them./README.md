<h2><a href="https://www.codechef.com/learn/course/plaksha-dsa-roadmap-2/KJASD13/problems/ZJIHK01?tab=Submissions">Chef Counts Unique PathsChef has a robot that starts at the top-left corner of a grid and wants to reach the bottom-right corner. The grid contains some obstacles, marked as 1, while free spaces are marked as 0. 
...
The grid blocks paths with 1s; only 1 ways avoid obstacles from top-left to bottom-right by moving around them.</a></h2>