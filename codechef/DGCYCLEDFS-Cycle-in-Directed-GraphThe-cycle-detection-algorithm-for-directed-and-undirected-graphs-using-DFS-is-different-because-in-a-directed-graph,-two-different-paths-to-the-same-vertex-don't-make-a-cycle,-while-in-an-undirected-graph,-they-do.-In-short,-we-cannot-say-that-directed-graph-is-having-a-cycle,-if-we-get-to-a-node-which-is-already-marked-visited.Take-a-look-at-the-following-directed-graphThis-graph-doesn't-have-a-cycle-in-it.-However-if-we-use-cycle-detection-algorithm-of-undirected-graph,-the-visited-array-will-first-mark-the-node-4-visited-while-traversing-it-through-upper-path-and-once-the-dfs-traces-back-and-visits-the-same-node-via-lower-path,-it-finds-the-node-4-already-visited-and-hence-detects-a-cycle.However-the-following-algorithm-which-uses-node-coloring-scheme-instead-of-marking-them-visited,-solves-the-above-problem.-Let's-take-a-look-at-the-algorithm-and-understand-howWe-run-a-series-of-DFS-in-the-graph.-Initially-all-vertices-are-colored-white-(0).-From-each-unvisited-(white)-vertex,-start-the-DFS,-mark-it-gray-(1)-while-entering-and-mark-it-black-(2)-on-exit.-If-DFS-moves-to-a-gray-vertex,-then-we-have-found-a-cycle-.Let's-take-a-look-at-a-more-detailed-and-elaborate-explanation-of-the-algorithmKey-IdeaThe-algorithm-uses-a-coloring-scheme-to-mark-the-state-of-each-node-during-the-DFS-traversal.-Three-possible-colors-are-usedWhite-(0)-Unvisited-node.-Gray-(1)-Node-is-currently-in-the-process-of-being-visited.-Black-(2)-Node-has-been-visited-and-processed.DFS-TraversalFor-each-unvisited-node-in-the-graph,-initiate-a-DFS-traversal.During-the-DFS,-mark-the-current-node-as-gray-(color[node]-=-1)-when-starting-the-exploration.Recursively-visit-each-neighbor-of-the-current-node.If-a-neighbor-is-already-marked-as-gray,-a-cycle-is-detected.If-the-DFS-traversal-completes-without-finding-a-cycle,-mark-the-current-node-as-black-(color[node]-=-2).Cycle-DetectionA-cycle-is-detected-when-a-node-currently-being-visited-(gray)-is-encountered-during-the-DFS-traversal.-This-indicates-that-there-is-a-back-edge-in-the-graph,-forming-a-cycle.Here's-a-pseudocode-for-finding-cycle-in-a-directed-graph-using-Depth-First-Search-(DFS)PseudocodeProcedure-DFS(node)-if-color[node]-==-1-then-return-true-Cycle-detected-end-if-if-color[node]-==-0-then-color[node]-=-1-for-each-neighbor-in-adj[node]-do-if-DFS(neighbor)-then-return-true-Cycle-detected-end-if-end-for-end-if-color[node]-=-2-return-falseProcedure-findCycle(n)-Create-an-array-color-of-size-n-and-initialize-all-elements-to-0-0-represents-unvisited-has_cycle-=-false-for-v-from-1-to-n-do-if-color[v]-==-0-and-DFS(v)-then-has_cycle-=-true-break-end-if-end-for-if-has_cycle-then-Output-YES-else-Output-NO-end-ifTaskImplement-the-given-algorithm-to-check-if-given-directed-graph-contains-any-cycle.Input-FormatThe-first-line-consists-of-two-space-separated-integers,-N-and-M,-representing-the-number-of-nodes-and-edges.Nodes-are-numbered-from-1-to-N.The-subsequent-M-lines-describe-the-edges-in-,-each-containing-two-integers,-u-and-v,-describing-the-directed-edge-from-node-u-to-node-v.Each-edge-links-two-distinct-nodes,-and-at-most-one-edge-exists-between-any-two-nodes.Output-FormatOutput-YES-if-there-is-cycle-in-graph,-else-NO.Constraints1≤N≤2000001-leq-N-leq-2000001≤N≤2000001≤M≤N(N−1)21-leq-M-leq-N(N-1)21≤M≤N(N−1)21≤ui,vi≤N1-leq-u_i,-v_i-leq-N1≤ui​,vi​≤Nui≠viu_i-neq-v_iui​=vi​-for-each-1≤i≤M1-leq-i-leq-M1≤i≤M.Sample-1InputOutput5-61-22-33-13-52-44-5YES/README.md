<h2><a href="https://www.codechef.com/learn/course/plaksha-dsa-roadmap-2/KJASD12/problems/DGCYCLEDFS?tab=Submissions">Cycle in Directed GraphThe cycle detection algorithm for directed and undirected graphs using DFS is different because in a directed graph, two different paths to the same vertex don't make a cycle, while in an undirected graph, they do. In short, we cannot say that directed graph is having a cycle, if we get to a node which is already marked visited.
