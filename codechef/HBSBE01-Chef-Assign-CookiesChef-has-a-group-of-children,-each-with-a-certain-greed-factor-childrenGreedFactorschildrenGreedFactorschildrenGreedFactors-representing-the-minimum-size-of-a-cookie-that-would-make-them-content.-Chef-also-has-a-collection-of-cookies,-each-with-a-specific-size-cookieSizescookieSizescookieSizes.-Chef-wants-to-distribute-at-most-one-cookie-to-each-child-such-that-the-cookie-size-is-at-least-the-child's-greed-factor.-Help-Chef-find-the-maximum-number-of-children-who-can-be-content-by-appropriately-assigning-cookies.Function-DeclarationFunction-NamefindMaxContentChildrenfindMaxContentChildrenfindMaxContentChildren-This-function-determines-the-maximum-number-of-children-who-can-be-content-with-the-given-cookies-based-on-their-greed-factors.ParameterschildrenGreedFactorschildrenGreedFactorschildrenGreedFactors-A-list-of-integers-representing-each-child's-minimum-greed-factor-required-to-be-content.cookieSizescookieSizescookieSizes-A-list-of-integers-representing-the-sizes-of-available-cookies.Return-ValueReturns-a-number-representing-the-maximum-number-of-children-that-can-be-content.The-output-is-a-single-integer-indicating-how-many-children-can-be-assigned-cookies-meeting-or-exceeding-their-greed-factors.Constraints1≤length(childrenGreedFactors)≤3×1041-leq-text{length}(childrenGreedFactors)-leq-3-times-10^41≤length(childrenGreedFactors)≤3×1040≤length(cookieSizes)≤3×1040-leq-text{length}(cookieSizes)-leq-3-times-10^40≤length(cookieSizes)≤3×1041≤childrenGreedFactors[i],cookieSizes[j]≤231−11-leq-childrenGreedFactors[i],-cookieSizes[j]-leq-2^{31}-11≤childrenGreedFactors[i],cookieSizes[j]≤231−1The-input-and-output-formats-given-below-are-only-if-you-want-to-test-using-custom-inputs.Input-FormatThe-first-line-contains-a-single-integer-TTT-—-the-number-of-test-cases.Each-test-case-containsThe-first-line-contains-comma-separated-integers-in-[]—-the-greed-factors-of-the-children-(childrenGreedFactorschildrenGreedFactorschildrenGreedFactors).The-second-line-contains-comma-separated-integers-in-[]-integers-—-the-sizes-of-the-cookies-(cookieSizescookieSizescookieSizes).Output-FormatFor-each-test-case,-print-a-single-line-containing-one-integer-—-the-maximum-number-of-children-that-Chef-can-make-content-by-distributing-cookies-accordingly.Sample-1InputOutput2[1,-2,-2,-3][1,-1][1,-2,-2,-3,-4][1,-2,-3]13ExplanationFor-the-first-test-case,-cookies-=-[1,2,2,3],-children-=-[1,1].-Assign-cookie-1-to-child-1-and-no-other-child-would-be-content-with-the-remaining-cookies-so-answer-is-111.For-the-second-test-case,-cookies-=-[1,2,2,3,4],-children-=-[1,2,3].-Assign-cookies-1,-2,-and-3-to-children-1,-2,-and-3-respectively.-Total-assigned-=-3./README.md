<h2><a href="https://www.codechef.com/learn/course/plaksha-dsa-roadmap-2/KJASD13/problems/HBSBE01?tab=Submissions">Chef Assign CookiesChef has a group of children, each with a certain greed factor childrenGreedFactorschildrenGreedFactorschildrenGreedFactors representing the minimum size of a cookie that would make them content. 
...
For the second test case, cookies = [1,2,2,3,4], children = [1,2,3]. Assign cookies 1, 2, and 3 to children 1, 2, and 3 respectively. Total assigned = 3.</a></h2>