<h2><a href="https://www.codechef.com/practice/course/linked-lists/LINKLISTF/problems/PREP55?tab=Submissions">Remove Duplicates from Sorted ListYou are given head of the non-empty sorted linked list where the value of the ithi^{th}ith node will be AiA_iAi​.
...
Test case 333: We will remove duplicate entry of 555. So the sorted linked list will be 555.</a></h2>